...
![Screenshot of the CloudCtrl app](https://i.imgur.com/kYmBwT3.png)
*(Tip: you can create your own screenshot of the app and replace this image for a live preview)*
